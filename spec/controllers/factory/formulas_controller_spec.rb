...
RSpec.describe Factory::FormulasController, type: :controller do
  ...
  let(:element1) { create(:formula_element) }
  let(:element2) { create(:formula_element) }
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      let(:formula) { Formula.create! valid_attributes.merge(abrasive: 'OAK') }
      ...
      it "updates the requested factory_formula" do
        put :update,
          params: {id: formula.to_param, formula: new_attributes},
      ...
      it "assigns the requested factory_formula as @factory_formula" do
        put :update,
          params: {id: formula.to_param, formula: valid_attributes},
          session: valid_session
        expect(assigns(:formula)).to eq(formula)
      end
    ...
    context "with invalid params" do
      it "assigns the factory_formula as @factory_formula" do
        formula = Formula.create! valid_attributes
        put :update,
          params: {id: formula.to_param, formula: invalid_attributes},
          session: valid_session
        expect(assigns(:formula)).to eq(formula)
      end
