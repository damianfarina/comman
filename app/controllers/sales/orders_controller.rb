module Sales
  class OrdersController < ApplicationController
    ...
    def create
      ...
      respond_to do |format|
        if @sales_order.save && confirm_if_requested
          format.html { redirect_to [ @sales_order ], notice: t(".success") }
      ...
      respond_to do |format|
        format.turbo_stream do
          render turbo_stream: turbo_stream.replace(
            ...
            partial: "sales/orders/sales_order_totals",
    ...
    def update
      respond_to do |format|
        if @sales_order.update(sales_order_params) && confirm_if_requested
          format.html { redirect_to [ :edit, @sales_order ], notice: t(".success") }
    ...
    def destroy
      ...
      respond_to do |format|
        format.html { redirect_to sales_orders_path, status: :see_other, notice: t(".success") }
